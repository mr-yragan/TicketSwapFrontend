    ...
    return (
        <header className="bg-white border-b border-gray-300">
            <div className="max-w-350 mx-auto px-8 py-4 flex justify-between items-center">
                <h1
                    className="text-2xl font-700 cursor-pointer hover:text-gray-700 transition-colors"
                    ...
                    {isAuthenticated ? (
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-800 bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer">
                                {user?.email || 'Профиль'}
                            </button>
                            <Button
                                variant="outline"
